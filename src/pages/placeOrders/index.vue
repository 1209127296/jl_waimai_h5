  ...
  export default {
    ...
    onShow(){
      if(this.isFirst){
        ...
        this.isFirst=true;
        wx.redirectTo({
          url:"/pages/placeOrders/main?deliverMoney="+Number(this.$root.$mp.query.deliverMoney)+"&shopName="+this.$root.$mp.query.shopName+"&shopId="+this.$root.$mp.query.shopId+"&totalMoney="+parseInt(this.$root.$mp.query.totalMoney)
        })
      }
    },
    mounted() {
